"""
Django settings for odg project.
...
SECRET_KEY = '5q3-0+0@($-i%*($rhod)hnu@54m!8r7u_b1@ajj@=@)j#jn(3'
...
'PLUGINS': {
    'leaflet.markercluster': {
        'css': ['https://cdnjs.cloudflare.com/ajax/libs/leaflet.markercluster/1.4.1/MarkerCluster.Default.css'],
